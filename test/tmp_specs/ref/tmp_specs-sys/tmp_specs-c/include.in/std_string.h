...
typedef struct std____cxx11__basic_string_char__t_s {
    char data[%SIZEstd::__cxx11::basic_string<char>%];
} TMP_SPECS_CPPMM_ALIGN(%ALIGNstd::__cxx11::basic_string<char>%) std____cxx11__basic_string_char__t;
...
} TMP_SPECS_CPPMM_ALIGN(%ALIGNstd::vector<std::string>%) std__vector_std__string__t;
