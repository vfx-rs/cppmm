...
inline OpenImageIO_v2_2::Filesystem::IOProxy & to_cpp_ref(
    OpenImageIO_v2_2_Filesystem_IOProxy * rhs)
{
...
inline OpenImageIO_v2_2_Filesystem_IOProxy const * to_c(
    OpenImageIO_v2_2::Filesystem::IOProxy const & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_Filesystem_IOProxy const * >(&(rhs));
}
...
inline OpenImageIO_v2_2_Filesystem_IOProxy * to_c(
    OpenImageIO_v2_2::Filesystem::IOProxy & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_Filesystem_IOProxy * >(&(rhs));
}
...
inline OpenImageIO_v2_2::Filesystem::IOMemReader & to_cpp_ref(
    OpenImageIO_v2_2_Filesystem_IOMemReader * rhs)
{
...
inline OpenImageIO_v2_2_Filesystem_IOMemReader const * to_c(
    OpenImageIO_v2_2::Filesystem::IOMemReader const & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_Filesystem_IOMemReader const * >(&(rhs));
}
...
inline OpenImageIO_v2_2_Filesystem_IOMemReader * to_c(
    OpenImageIO_v2_2::Filesystem::IOMemReader & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_Filesystem_IOMemReader * >(&(rhs));
}
