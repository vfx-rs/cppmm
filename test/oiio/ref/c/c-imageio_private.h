...
inline OpenImageIO_v2_2::ROI const & to_cpp_ref(
    OpenImageIO_v2_2_ROI const * rhs)
{
...
inline OpenImageIO_v2_2_ROI const * to_c(
    OpenImageIO_v2_2::ROI const & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ROI const * >(&(rhs));
}
...
inline OpenImageIO_v2_2_ROI * to_c(
    OpenImageIO_v2_2::ROI & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ROI * >(&(rhs));
}
...
inline OpenImageIO_v2_2::ImageSpec & to_cpp_ref(
    OpenImageIO_v2_2_ImageSpec * rhs)
{
...
inline OpenImageIO_v2_2_ImageSpec const * to_c(
    OpenImageIO_v2_2::ImageSpec const & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ImageSpec const * >(&(rhs));
}
...
inline OpenImageIO_v2_2_ImageSpec * to_c(
    OpenImageIO_v2_2::ImageSpec & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ImageSpec * >(&(rhs));
}
...
inline OpenImageIO_v2_2_ImageSpec to_c_copy(
    OpenImageIO_v2_2::ImageSpec const & rhs)
{
...
inline OpenImageIO_v2_2::ImageInput const & to_cpp_ref(
    OpenImageIO_v2_2_ImageInput const * rhs)
{
...
inline OpenImageIO_v2_2::ImageInput & to_cpp_ref(
    OpenImageIO_v2_2_ImageInput * rhs)
{
...
inline OpenImageIO_v2_2_ImageInput const * to_c(
    OpenImageIO_v2_2::ImageInput const & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ImageInput const * >(&(rhs));
}
...
inline OpenImageIO_v2_2_ImageInput * to_c(
    OpenImageIO_v2_2::ImageInput & rhs)
{
    return reinterpret_cast<OpenImageIO_v2_2_ImageInput * >(&(rhs));
}
